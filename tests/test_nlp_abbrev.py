import logging
import unittest
from batterydataextractor.nlp import ChemAbbreviationDetector
...
class TestChemAbbreviationDetector(unittest.TestCase):
    ...
    def test_abbr3(self):
        ...
        ad = ChemAbbreviationDetector()
        self.assertEqual(
            [(['15-ADON'], ['15-acetyldeoxynivalenol']), (['3-ADON'], ['3-acetyldeoxynivalenol']), (['FX'], ['fusarenon', 'X']), (['NIV'], ['nivalenol'])],
